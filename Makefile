...
client: bin/object/client_wrap.o bin/object/client.o bin/object/common.o Makefile common
	${CC} ${CCFLAGS} -o bin/client bin/object/client_wrap.o bin/object/client.o bin/object/common.o
server: bin/object/server_wrap.o bin/object/server.o bin/object/common.o Makefile common
	${CC} ${CCFLAGS} -o bin/server bin/object/server_wrap.o bin/object/server.o bin/object/common.o
check: bin/object/check.o bin/object/client.o bin/object/server.o bin/object/common.o Makefile common
...
bin/object/common.o: Makefile common
